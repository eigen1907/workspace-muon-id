...
#include "TH1F.h" // <- for TH1F histograms
...
private:
  ...
  // -------------------------------
  // NEW: Histograms for time measurement
  // -------------------------------
  TH1F* hBlock1Time_;  // muons first
  TH1F* hBlock2Time_;  // links second
  TH1F* hBlock3Time_;  // tracker & calo muons
  TH1F* hBlock4Time_;  // stand alone muons
  TH1F* hBlock5Time_;  // after that (final fill, etc.)
};
#endif
